...
use zdc_hir::{
    ...
    Foreign, Function, Hir, HirArg, HirArm, HirArmBody, HirBind, HirBinding, HirBlock, HirEach,
    ...
    HirWhenNode, Local, LocalId, LocalSignal, OperatorName, Record, Res, Signal, Variant, View,
    BUILTIN_OF_OPERATORS,
};
