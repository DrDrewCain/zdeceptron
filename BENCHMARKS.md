...
|---|---|---|---|---|---|---|
| `examples/hello.zd` | 708 | 208 | 3641 | 731 | 122 | 5410 |
| `examples/counter.zd` | 1046 | 208 | 3641 | 829 | 142 | 5866 |
| `crates/zdc-bench/bench/row.zd` | 913 | 208 | 3641 | 723 | 163 | 5648 |
...
behind it.** Since #140 the runtime carries assertions inside `// $dev` … `// $end` markers, and
`zdc build` strips them while `zdc dev` serves them. The rows above are what a reader downloads;
the difference is what a developer runs against, and it is regenerated by the same survey that
produces the per-line table:
