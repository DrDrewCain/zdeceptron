...
| [The examples](https://zdeceptron.marksturman.com/docs/examples) | All thirty-five programs, ordered by what they teach. |
...
All thirty-five programs in [`examples/`](examples/) **pass `zdc check` and produce a bundle
...
All thirty-five are listed with what each one teaches in
