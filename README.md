...
| [The examples](https://zdeceptron.marksturman.com/docs/examples) | All thirty-six programs, ordered by what they teach. |
...
All thirty-six programs in [`examples/`](examples/) **pass `zdc check` and produce a bundle
...
All thirty-six are listed with what each one teaches in
