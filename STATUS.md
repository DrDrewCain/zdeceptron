...
| `zdc-hir` | 40 | |
| `zdc-runtime` | 60 | Two of these run the JavaScript suites — further assertions the count above does not see. |
| `zdc-ast` | 12 | |
