...
**`examples/` holds thirty-one files. All thirty-one check and all thirty-one build.**

The thirtieth is `sorting.test.zd`, and it is a file rather than a program: it declares no
